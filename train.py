...
def train(x_train, y_train, vocab_size, feature_size, save_path):
    ...
    model.summary()
    model.compile(tf.optimizers.Adam(learning_rate=args.learning_rate), loss='binary_crossentropy',
    ...
    history = model.fit(x=x_train, y=y_train, batch_size=args.batch_size, epochs=args.epochs, steps_per_epoch=19302//args.batch_size,
